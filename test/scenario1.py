...
assert tei_bto.text.body.div[2].head == "Titre de la sous-partie 1", tei_bto.text.body.div[2].head
...
assert tei_bto.text.body.div[3].head == "POSTFACI", tei_bto.text.body.div[3].head
...
assert tei_bto.text.body.div[4].head == "Titre du chapitre 1", tei_bto.text.body.div[4].head
...
assert tei_bto.text.body.div[4].div[0].head == "Titre de la sous-partie du chapitre 1", tei_bto.text.body.div[4].div[0].head
...
assert tei_bto.text.body.div[5].head == "Dernier chapitre", tei_bto.text.body.div[5].head
...
assert tei_bto.text.back.epilogue.div[0].head == "Epilòg", tei_bto.text.back.epilogue.div[0].head
...
assert tei_bto.text.back.epilogue.div[1].head == "TITOL", tei_bto.text.back.epilogue.div[1].head
...
assert tei_bto.text.back.div[0].head == None, tei_bto.text.back.div[0].head
...
assert tei_bto.text.back.div[0].note.div[0].head == "NOTES DE L'AUTEUR", tei_bto.text.back.div[0].note.div[0].head
...
assert tei_bto.text.back.div[0].note.div[1].head == "TITRE", tei_bto.text.back.div[0].note.div[0].head
...
assert tei_pclv8.teiHeader.fileDesc.editionStmt.edition == "Series", tei_pclv8.teiHeader.fileDesc.editionStmt.edition
...
assert tei_pclv8.teiHeader.fileDesc.publicationStmt.availability.status == "restricted", tei_pclv8.teiHeader.fileDesc.publicationStmt.availability.status
assert tei_pclv8.teiHeader.fileDesc.publicationStmt.availability.licence == "à utiliser dans un cadre de recherche ou d'enseignement après accord du dépositaire des droits", tei_pclv8.teiHeader.fileDesc.publicationStmt.availability.licence
...
assert tei_pclv8.text.body.div[0].head == None, tei_pclv8.text.body.div[0].head
...
assert tei_pclv8.text.body.div[1].head == None, tei_pclv8.text.body.div[1].head
...
assert tei_pclv8.text.body.div[2].head == "Titre de la sous-partie 1", tei_pclv8.text.body.div[2].head
...
assert tei_pclv8.text.body.div[3].head == "POSTFACI", tei_pclv8.text.body.div[3].head
...
assert tei_pclv8.text.body.div[4].head == "Titre du chapitre 1", tei_pclv8.text.body.div[4].head
...
assert tei_pclv8.text.body.div[5].head == "Titre de la sous-partie du chapitre 1", tei_pclv8.text.body.div[5].head
...
assert tei_pclv8.text.body.div[6].head == None, tei_pclv8.text.body.div[6].head
...
assert tei_pclv8.text.body.div[7].head == "Dernier chapitre", tei_pclv8.text.body.div[7].head
...
assert tei_pclv8.text.body.div[8].head == "Epilòg", tei_pclv8.text.body.div[8].head
...
assert tei_pclv8.text.body.div[9].head == "TITOL", tei_pclv8.text.body.div[9].head
...
pyteilib.tei_write(tei_pclv8, OUTPUT_DIR + "example1_pclv8.xml", xml_type='PCLv8')
...
assert tei_pclv9.teiHeader.fileDesc.editionStmt.edition == "Series", tei_pclv9.teiHeader.fileDesc.editionStmt.edition
...
assert tei_pclv9.teiHeader.fileDesc.publicationStmt.availability.status == "restricted", tei_pclv9.teiHeader.fileDesc.publicationStmt.availability.status
assert tei_pclv9.teiHeader.fileDesc.publicationStmt.availability.licence == "à utiliser dans un cadre de recherche ou d'enseignement après accord du dépositaire des droits", tei_pclv9.teiHeader.fileDesc.publicationStmt.availability.licence
...
assert tei_pclv9.text.body.div[0].head == None, tei_pclv9.text.body.div[0].head
...
assert tei_pclv9.text.body.div[1].head == None, tei_pclv9.text.body.div[1].head
...
assert tei_pclv9.text.body.div[2].head == "Titre de la sous-partie 1", tei_pclv9.text.body.div[2].head
...
assert tei_pclv9.text.body.div[3].head == "POSTFACI", tei_pclv9.text.body.div[3].head
...
assert tei_pclv9.text.body.div[4].head == "Titre du chapitre 1", tei_pclv9.text.body.div[4].head
...
assert tei_pclv9.text.body.div[5].head == "Titre de la sous-partie du chapitre 1", tei_pclv9.text.body.div[5].head
...
assert tei_pclv9.text.body.div[6].head == None, tei_pclv9.text.body.div[6].head
...
assert tei_pclv9.text.body.div[7].head == "Dernier chapitre", tei_pclv9.text.body.div[7].head
...
assert tei_pclv9.text.body.div[8].head == "Epilòg", tei_pclv9.text.body.div[8].head
...
assert tei_pclv9.text.body.div[9].head == "TITOL", tei_pclv9.text.body.div[9].head
...
pyteilib.tei_write(tei_pclv9, OUTPUT_DIR + "example1_pclv9.xml", xml_type='PCLv9')
...
# Test text back
assert tei_bto_hi.text.back.epilogue.div[0].head == "<hi rend=\"G\">Epilòg</hi>", tei_bto_hi.text.back.epilogue.div[0].head
...
assert tei_bto_hi.text.back.div[0].note.div[0].head == "<hi rend=\"G\">NOTES DE L'AUTEUR</hi>", tei_bto_hi.text.back.div[0].note.div[0].head
...
assert tei_pclv8_hi.text.body.div[8].head == "<hi rend=\"G\">Epilòg</hi>", tei_pclv8_hi.text.body.div[8].head
...
## Write it to ParCoLab v8 XML
pyteilib.tei_write(tei_pclv8_hi, OUTPUT_DIR + "example1_pclv8_hi.xml", xml_type='PCLv8')
...
assert tei_pclv9_hi.text.body.div[8].head == "<hi rend=\"G\">Epilòg</hi>", tei_pclv9_hi.text.body.div[8].head
...
## Write it to ParCoLab v9 XML
pyteilib.tei_write(tei_pclv9_hi, OUTPUT_DIR + "example1_pclv9_hi.xml", xml_type='PCLv9')
